        ...
        >
          <div className="glass p-8 rounded-lg max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              These certifications represent my commitment to mastering the intersection of 
              business analysis and data analytics. From professional credentials in Power BI 
              and Google Data Analytics to specialized training in Agile and Process Management, 
              these validate my ability to deliver high-impact business solutions.
            </p>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              {[
                { label: 'Key Certifications', count: '5' },
                { label: 'Leading Platforms', count: '3' },
                { label: 'Data Expertise', count: '4+ Years' },
                { label: 'Business Skills', count: '10+' },
              ].map((stat, index) => (
                <motion.div
                  key={index}
