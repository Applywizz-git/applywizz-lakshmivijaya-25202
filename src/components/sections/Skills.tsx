...
const skillCategories = [
  { id: 'analysis', label: 'Business Analysis', icon: Database, data: portfolioData.skills.analysis },
  { id: 'data', label: 'Data & BI', icon: Code, data: portfolioData.skills.data },
  { id: 'tools', label: 'Tools & Platforms', icon: Settings, data: portfolioData.skills.tools },
  { id: 'methodology', label: 'Process & Agile', icon: Cloud, data: portfolioData.skills.methodology },
];
          ...
          >
            <div className="glass p-8 rounded-lg max-w-4xl mx-auto">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                With a strong foundation in business analysis and financial services, I've mastered a comprehensive suite of tools 
                for requirement gathering, process optimization, and data visualization. From documenting complex technical 
                specifications to building interactive KPI dashboards, my skill set ensures seamless collaboration between 
                business stakeholders and technical teams.
              </p>
              
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                {[
                  { label: 'Analysis Experience', count: portfolioData.skills.analysis.length },
                  { label: 'Data & BI Tools', count: portfolioData.skills.data.length },
                  { label: 'Platforms & Tools', count: portfolioData.skills.tools.length },
                  { label: 'Process Methodologies', count: portfolioData.skills.methodology.length },
                ].map((stat, index) => (
